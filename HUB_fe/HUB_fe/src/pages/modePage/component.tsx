...
export default function ModeButton({ onClick, label, info}: ModeButtonProps) {
    ...
    return (
        <button
            ...
            onClick={onClick}
        >
            <span className="mb-5 flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-lg font-bold text-cyan-600 transition group-hover:bg-cyan-100">+</span>
